        ...
        if len(data_dir_beam_list) != 0:
            ...
            for data_dir_beam in data_dir_beam_list:
                ...
                if os.path.exists(cube_file):
                    ...
                    # write noise data
                    cube_info.write(
                        "{0:s}/beam_{1:s}_cube_contsub_noise_info.csv".format(qa_line_beam_dir, beam), format="csv", overwrite=True)
                    ...
                    plt.savefig(
                        '{0:s}/beam_{1:s}_cube_contsub_noise.png'.format(qa_line_beam_dir, beam), dpi=300)
                    plt.close('all')
                    ...
                    logging.warning(
                        "No HI continuum subtracted cube found for beam {0:s}".format(beam))
