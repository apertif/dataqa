...
#Run Aegean / PyBDSF for source finding
    ...
    if finder == 'aegean':
        ...
        IMG.run_Aegean(ncores=ncores, redo=refind, params=finder_params, write=write_all)
    elif finder == 'pybdsf':
        main_cat = IMG.cat_comp
        IMG.run_PyBDSF(ncores=ncores, redo=refind, params=finder_params, write=write_all)
