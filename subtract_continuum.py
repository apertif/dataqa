...
- It creates a new fits file in: '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube_contsub.fits' 
...
def subract_cont(data, beams):
	for i in beams:
		if os.path.exists('/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube.fits'):
			...
			fits.in_ = '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube.fits'
			fits.out = '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube.mir'
			fits.op = 'xyin'
			fits.go()

			contsub = lib.miriad('contsub')
			contsub.in_ = '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube.mir'
			contsub.mode = "poly,1 'contchan=(1,800)'"
			contsub.out = '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube_contsub.mir'
			contsub.go()

			fits.in_ = '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube_contsub.mir'
			fits.out = '/'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube_contsub.fits'
			fits.op = 'xyout'
			fits.go()

			os.system('rm -rf /'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube_contsub.mir') 
			os.system('rm -rf /'+str(data)+'/apertif/'+str(data_dir)+'/'+str(i)+'/line/cubes/HI_image_cube.mir') 			
